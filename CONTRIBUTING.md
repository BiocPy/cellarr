...
Welcome to `cellarr` contributor's guide.
...
If you experience bugs or general issues with `cellarr`, please have a look
...
You can help improve `cellarr` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`cellarr` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `cellarr`'s files. While this mechanism can
...
```
conda create -n cellarr python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/cellarr.git
   cd cellarr
   ```
...
5. Install [pre-commit]:
   ...
   `cellarr` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/cellarr
[issue tracker]: https://github.com/<USERNAME>/cellarr/issues
