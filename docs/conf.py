...
module_dir = os.path.join(__location__, "../src/cellarr")
try:
...
try:
    from cellarr import __version__ as version
except ImportError:
    version = ""
...
latex_documents = [
    ("index", "user_guide.tex", "cellarr Documentation", "Jayaram Kancherla", "manual")
]
